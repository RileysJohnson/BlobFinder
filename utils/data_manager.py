"""Manages all file I/O, including loading images and saving results."""

# #######################################################################
#                     UTILITIES: DATA MANAGEMENT
#
#   CONTENTS:
#       - class DataManager: A collection of static methods for:
#           - create_igor_folder_structure()
#           - save_wave_data()
#           - load_image_file()
#           - create_particle_info()
#
# #######################################################################
...
from .error_handler import handle_error, safe_print, HessianBlobError
